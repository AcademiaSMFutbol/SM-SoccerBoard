...
function changeField(val) {
  ...
  if (val==='blank') { fMaster.style.backgroundImage='none'; fMaster.classList.add('field-blank'); }
    ...
    fMaster.style.backgroundSize='100% 100%'; fMaster.style.backgroundRepeat='no-repeat';
    fMaster.style.backgroundPosition='center'; fMaster.classList.remove('field-blank');
  }
}
